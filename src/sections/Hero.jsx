  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-10 pointer-events-none">
        ...
        <div
          className="absolute bottom-10 right-10 w-96 h-96 rounded-full bg-white filter blur-3xl animate-float"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-20 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left animate-fade-in-up">
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-md px-4 py-1.5 rounded-full border border-white/20 text-brand-cyan-light text-xs sm:text-sm font-semibold tracking-wider uppercase">
              ...
              <span>Alkaline Water with 8+ pH</span>
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight">
              AIVRA <br />
              <span className="text-gradient-cyan">Elegance You Can Drink</span>
            </h1>

            <p className="text-base sm:text-lg text-brand-blue-light/90 max-w-xl mx-auto lg:mx-0 leading-relaxed font-light">
              We provide premium quality alkaline water sourced, purified, and
              packed under strict quality controls to ensure safe drinking water
            ...
            <div className="grid grid-cols-3 gap-4 pt-8 max-w-md mx-auto lg:mx-0 border-t border-white/10">
              <div>
                ...
                <p className="text-xs text-brand-blue-light/75 uppercase tracking-wider">
                  Alkaline Water
                </p>
              </div>
              <div>
          ...
          <div
            className="lg:col-span-5 flex justify-center items-center relative animate-fade-in"
        ...
        {/* Scroll Indicator */}
        <div
          className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center cursor-pointer opacity-80 hover:opacity-100 transition-opacity"
          onClick={handleScrollToAbout}
        >
          <span className="text-xs text-brand-blue-light uppercase tracking-widest mb-2 font-medium"></span>
